...
<table border><tr><td>Staff ID</td><td>Staff Name</td><td>Location</td><td>Regn Date</td></tr>
<% 
while (it.hasNext())
{
	        Staff  staff =(Staff)it.next();
out.println("<tr><td>" +staff.getSid()  + "</td><td>" + staff.getSname() + "</td><td>" + staff.getLocation() + "</td><td>" + staff.getDor() + "</td></tr>");
}
out.println("<table>");
