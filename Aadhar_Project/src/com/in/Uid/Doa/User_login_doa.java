	...
	public static boolean check_login_credentails(User_login user_login)
	{
		boolean check_credentails=false;
	       try {
				   ...
				   PreparedStatement preparedstatement = connection.prepareStatement("Select * from admin where uid='"+user_login.getUid()+"' and pwd='"+user_login.getPassword()+"'");
				   ResultSet resultset = preparedstatement.executeQuery();
				   if(resultset.next()){check_credentails=true;}
				   else{check_credentails=false;} 
